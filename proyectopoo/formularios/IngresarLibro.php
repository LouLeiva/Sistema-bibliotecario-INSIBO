...
<br>
  ...
  <div class="form-group" style="display: flex; justify-content: center">
    <div class=" col-lg-1.5">
      <a href="librosImpresos.php"><input type="button" class="btn btn-primary" value="Libros Impresos"></a>
    </div>
    ...
    <div class="form-group" style="display: flex; justify-content: center">
    <div class=" col-lg-1.5">
      <a href="librosElectronicos.php"><input type="button" class="btn btn-primary" value="Libros Electronicos"></a>
    </div>
