...
<br>
  ...
  <div class="form-group" style="display: flex; justify-content: center">
    <div class=" col-lg-1.5">
      <a href="RecursosImpresos.php"><input type="button" class="btn btn-primary" value="Recursos Impresos"></a>
    </div>
    ...
    <div class="form-group" style="display: flex; justify-content: center">
    <div class=" col-lg-1.5">
      <a href="RecursosDigitales.php"><input type="button" class="btn btn-primary" value="Recursos Electrónicos"></a>
    </div>
